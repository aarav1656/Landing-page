...
import logo from '../public/undefined7.png'
import Image from "next/image";

const Foot: NextPage = () => {
  return (
    <div className="flex items-end w-full border-2 border-red-300 ">

    <footer className="w-full text-gray-700 border-t-2 body-font">
        <div
            className="container flex flex-col flex-wrap px-5 py-24 mx-auto md:items-center lg:items-start md:flex-row md:flex-no-wrap">
            <div className="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
                <a className="flex items-center justify-center font-medium text-gray-900 title-font md:justify-start">
                  
                            <Image src={logo} alt="kyte logo"></Image>
                </a>
                <p className="mt-2 text-sm text-gray-500">Bringing back trust in web3 </p>
                <div className="mt-4">
            ...
            <div className="flex flex-wrap flex-grow mt-10 -mb-10 text-center md:pl-20 md:mt-0 md:text-left">
                <div className="w-full px-4 lg:w-1/4 md:w-1/2">
                    <h2 className="mb-3 text-sm font-medium tracking-widest text-darkgray uppercase title-font">About</h2>
                    <nav className="mb-10 list-none">
                        <li className="mt-3">
                            <a className="text-gray-500cursor-pointer hover:text-gray-900">Company</a>
                        </li>
                        <li className="mt-3">
                            <a className="text-gray-500cursor-pointer hover:text-gray-900">Careers</a>
                        </li>
                        <li className="mt-3">
                ...
                <div className="w-full px-4 lg:w-1/4 md:w-1/2">
                    <h2 className="mb-3 text-sm font-medium tracking-widest text-darkgray uppercase title-font">Support</h2>
                    <nav className="mb-10 list-none">
                        <li className="mt-3">
                ...
                <div className="w-full px-4 lg:w-1/4 md:w-1/2">
                    <h2 className="mb-3 text-sm font-medium tracking-widest text-darkgray uppercase title-font">Platform
                    </h2>
                    <nav className="mb-10 list-none">
                        <li className="mt-3">
                ...
                <div className="w-full px-4 lg:w-1/4 md:w-1/2">
                    <h2 className="mb-3 text-sm font-medium tracking-widest text-darkgray uppercase title-font">Contact</h2>
                    <nav className="mb-10 list-none">
                        <li className="mt-3">
